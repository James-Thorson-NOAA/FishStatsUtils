...
#' @export
plot_loadings = function( L_pj, At=1:nrow(L_pj), whichfactor=1, addtitle=TRUE, LabelPosition="Right",
  Buffer=c(0,0.1), Labels=rownames(L_pj), Cex=1.2, legend_text="Proportion of explained variance", ... ){
