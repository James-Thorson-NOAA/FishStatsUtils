...
#' \describe{
#'   \item{dharmaRes}{Output from \code{\link{summary.fit_model}}, representing quantile residuals calculated using package DHARMa; see that documentation for details}
