...
#' \describe{
#'   \item{Q}{Output from \code{\link{plot_quantile_diagnostic}}; see that documentation for definition of optional arguments and contents}
...
plot_results = function( fit, settings=fit$settings, plot_set=3, working_dir=paste0(getwd(),"/"),
  ...
  # return
  Return = list( "Q"=Q, "Enc_prob"=Enc_prob, "Index"=Index, "Proportions"=Proportions, "Range"=Range, "Dens_xt"=Dens_xt, "Edge"=Edge,
